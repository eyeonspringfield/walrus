...
IF (WALRUS_CUSTOM_INSTRUCTIONS)
    SET (WALRUS_DEFINITIONS ${WALRUS_DEFINITIONS} -DWALRUS_CUSTOM_INSTRUCTIONS)
    SET (WALRUS_SRC_LIST ${WALRUS_SRC_LIST} ${WALRUS_ROOT}/../src/emulator.c)
    MESSAGE(STATUS "Walrus Custom ARM32 Instructions: ON")
ENDIF()
